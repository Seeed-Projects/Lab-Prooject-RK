...
SERVER_CONTEXT = int(os.getenv('SERVER_CONTEXT', '4096'))
MODEL_MAX_CONTEXT = int(os.getenv('MODEL_MAX_CONTEXT', '38400'))
CLI_PREFILL_TPS = float(os.getenv('CLI_PREFILL_TPS', '135.58'))
CLI_GENERATE_TPS = float(os.getenv('CLI_GENERATE_TPS', '74.19'))
DEVICE_LABEL = os.getenv('DEVICE_LABEL', 'RK1828')
PRODUCT_LABEL = os.getenv('PRODUCT_LABEL', 'reComputer RK3576 Dev Kit + RK1828 AI Accelerator')

app = FastAPI(title='Qwen3-4B Long Context Test on RK1828')
